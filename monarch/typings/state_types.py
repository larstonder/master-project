...
class VehicleParameters:
    """
    Represents the parameters of a vehicle.
    """
    def __init__(self, vx: float, vy: float, angular_velocity: float, steering_angle: float):
        self.vx = vx
        self.vy = vy
...
class VehicleState:
    ...
    def __init__(self, x: float, y: float, z: float, heading: float, id: int = None, vehicle_parameters: VehicleParameters = None):
        self.x = x
        self.y = y
        self.z = z
