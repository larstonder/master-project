...
class Waypoint:
    ...
    """
    def __init__(self, x: float, y: float, heading: float, vx: float, vy: float, angular_velocity: float, timestamp: float):
        self.x = x
        self.y = y
    ...
    def __eq__(self, other):
        if not isinstance(other, Waypoint):
            return NotImplemented
        return self.x == other.x and self.y == other.y and self.heading == other.heading and self.velocity == other.velocity